% from https://www.dsprelated.com/showcode/269.php

% See related: https://github.com/jonathonmh/Beagle_SDR_GPS/blob/master/verilog/rx/cic_gen.c
%   which is a C->to Verilog implementation for the KiwiSDR project
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp(' '), disp(' ')
disp(['N = ',num2str(N),',   R = ',num2str(R),',   M = ',num2str(M),',   Bin = ', num2str(Bin),',   Bout = ',num2str(Bout)])
